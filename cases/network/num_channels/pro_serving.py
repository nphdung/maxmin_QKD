...
channel_num = int(l_argv.pop())  # the number of channels on an edge
UG = ng.gen(nov,prob,channel_num_lb=channel_num,channel_num_ub=channel_num+1)   # generate the undirected topology
